...
int main(void) {
    ...
    key_sentence[0] = (word_t)"query";
    key_sentence[1] = (word_t)"anarchy";
    key_sentence[2] = (word_t)"zealous";
    key_sentence[3] = (word_t)"making";
    key_sentence[4] = (word_t)"please";
    ...
    plain_msg[0] = (word_t)"the";
    plain_msg[1] = (word_t)"mouse";
    plain_msg[2] = (word_t)"jumped";
    plain_msg[3] = (word_t)"out";
    plain_msg[4] = (word_t)"the";
    plain_msg[5] = (word_t)"recycling";
    plain_msg[6] = (word_t)"bin";
